...
func (_m *URLStorage) StoreManyWithContext(_a0 context.Context, long2ShortUrls map[string]string) ([]error, error) {
	...
	var r0 []error
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, map[string]string) ([]error, error)); ok {
		return rf(_a0, long2ShortUrls)
	}
